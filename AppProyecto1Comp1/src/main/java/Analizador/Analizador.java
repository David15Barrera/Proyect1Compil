...
public class Analizador extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  public int error_sym() {return 1;}
    ...
    public void setDtsRep(Reportes dtsRep) {
        this.dtsRep = dtsRep;
    }

    public Analizador(LexicoArch lexer) {
            super(lexer);
    }
    ...
    public void syntax_error(Symbol s) {
        errores.add("Error Sintactico: Lex: " + String.valueOf(s.value) + "      Line: " +  s.left + "    row: " +  s.right);
    }
...
class CUP$AnalizadorCiclo$actions {
  ...
  /** Constructor */
  CUP$AnalizadorCiclo$actions(Analizador parser) {
    this.parser = parser;
  }
...
dtsRep.agregarEtiqueta("<tr>");
		...
		try{ RESULT = Integer.parseInt(dtsRep.obtenerID(e, eleft)); ultimoID = e;}catch(Exception ex){errores.add("Error en ID: "+ e +" en Linea: " + eleft); RESULT = 0;}
